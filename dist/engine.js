    ...
    value: function evaluateRules(ruleArray, almanac) {
      ...
      return Promise.all(ruleArray.map(function (rule) {
        ...
        return rule.evaluate(almanac).then(function (ruleResult) {
          ...
          (0, _debug2.default)(ruleResult);
          if (ruleResult.result) {
            var _ref = almanac || {},
                factMap = _ref.factMap;

            var factMapKeys = factMap.keys();
            var factObj = {};
            ...
            try {
              for (var _iterator = factMapKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var key = _step.value;
            ...
            for (var field in ruleResult.event.params) {
              (0, _debug2.default)(field);
              var template = _handlebars2.default.compile(ruleResult.event.params[field]);
